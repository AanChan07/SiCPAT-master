                  ...
                  <div class="modal-body">
                    <form action="edit_cuti_tahunan.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="total_cuti" value="<?php echo $row['total_cuti']; ?>" required>
                      </div>
                      <div class="form-group">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST">
                  ...
                  <div class="form-group">
                    <label>Total Cuti</label>
                    <input class="form-control" type="number" name="total_cuti" required>
                  </div>
                  <div class="form-group">
