...
<html lang="en">
  <head>
    ...
    <title>SiCPAT | Dashboard User</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php?page=dashboard" class="site_title"><i class="fa fa-university"></i><span>  SiCPAT</span></a>
            </div>
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                <span>Tanjungpinang Kelas IA</span>
              </div>
            </div>
            <!-- /menu profile quick info -->
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                if ($jabatanpegawai == 'PANITERA' || $jabatanpegawai == 'SEKRETARIS' || $jabatanpegawai =='KETUA' || $jabatanpegawai =='PANMUD HUKUM' || $jabatanpegawai =='PANMUD GUGATAN' || $jabatanpegawai =='PANMUD PERMOHONAN' || $jabatanpegawai =='KASUBBAG KEPEGAWAIAN DAN ORTALA' || $jabatanpegawai =='KASUBBAG PERENCANAAN IT DAN PELAPORAN' || $jabatanpegawai =='KASUBBAG UMUM DAN KEUANGAN') {
                  ?>
                  ...
                  <li role="presentation" class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                      ...
                      if ($jabatanpegawai =='PANMUD HUKUM' || $jabatanpegawai =='PANMUD GUGATAN' || $jabatanpegawai =='PANMUD PERMOHONAN' || $jabatanpegawai =='KASUBBAG KEPEGAWAIAN DAN ORTALA' || $jabatanpegawai =='KASUBBAG PERENCANAAN IT DAN PELAPORAN' || $jabatanpegawai =='KASUBBAG UMUM DAN KEUANGAN') {
