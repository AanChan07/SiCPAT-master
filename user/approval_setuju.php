...
include "../database/koneksi.php";
  ...
  if (isset($_POST['simpan'])) {
    ...
    } elseif ($action == '197007302003122001') {
        $query = mysqli_query($koneksi, "UPDATE cuti_pegawai SET app_panmud_kasubag=1 , status_cuti='Diajukan' , ket_status_cuti='Menunggu Approval Panitera' , panitera_sekretaris='197007302003122001' WHERE id_cutipegawai='$id'");
    } elseif ($action == '197203151999031004') {
        $query = mysqli_query($koneksi, "UPDATE cuti_pegawai SET app_panmud_kasubag=1 , status_cuti='Diajukan' , ket_status_cuti='Menunggu Approval Sekretaris' , panitera_sekretaris='197203151999031004' WHERE id_cutipegawai='$id'");
