...
if (isset($_POST['submit'])) {
    ...
    $queryCuti = mysqli_query($koneksi, "SELECT sisa_cuti_n2, sisa_cuti_n1, sisa_cuti_n, total_cuti FROM tb_cuti_tahunan WHERE id_pegawai='$id_pegawai'");
    $dataCuti = mysqli_fetch_assoc($queryCuti);
    ...
    if ($jenis == 'Cuti Tahunan') {
        ...
        $updateCuti = mysqli_query($koneksi, "UPDATE tb_cuti_tahunan SET sisa_cuti_n2='$sisa_cuti_n2', sisa_cuti_n1='$sisa_cuti_n1', sisa_cuti_n='$sisa_cuti_n', total_cuti='$total_cuti' WHERE id_pegawai='$id_pegawai'");
    }
