                   ...
                   <div class="modal-body">
                     <form class="" action="delete_pegawai.php" method="get">
                       <div class="form-group">
                         ...
                         <label>Semua data user dan cuti akan hilang</label>
...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO pegawai VALUES (null, '$namapegawai','$nippegawai', '$jabatanpegawai', '$golpegawai', 'PENGADILAN AGAMA TANJUNGPINANG KELAS IA')");
