                ...
                <div class="col-sm-4">
                  <select name="aksi" id="aksi" class="form-control" required>
                    ...
                    if (!empty($hasilstoppaniterasekretaris['nama_pegawai'])) {
                     ...
                     // Approval Panmud
                    if ($jabatanstaff == 'PENGELOLA PENANGANAN PERKARA HUKUM' || $jabatanstaff == 'ANALIS PERKARA PERADILAN HUKUM' || $jabatanstaff == 'PENGELOLA PENANGANAN PERKARA PERMOHONAN' || $jabatanstaff == 'ANALIS PERKARA PERADILAN PERMOHONAN' || $jabatanstaff == 'PENGELOLA PENANGANAN PERKARA GUGATAN' || $jabatanstaff == 'ANALIS PERKARA PERADILAN GUGATAN') {

                        ?>
                        <option value="197007302003122001">Disetujui</option>
                        <option value="Perubahan">Perubahan</option>
                        <option value="Ditangguhkan">Ditangguhkan</option>
                        <option value="Tidak Disetujui">Tidak Disetujui</option>
                        <?php
                      ...
                      //Aproval kasubag
                      if ($jabatanstaff == 'STAFF PELAKSANA KEPEGAWAIAN DAN ORTALA' || $jabatanstaff == 'PENELAAH TEKNIS KEBIJAKAN' || $jabatanstaff == 'PRANATA KEUANGA APBN TERAMPIL' || $jabatanstaff == 'PENGOLAH DATA DAN INFORMASI' ) {

                        ?>
                        <option value="197203151999031004">Disetujui</option>
                        <option value="Perubahan">Perubahan</option>
                        <option value="Ditangguhkan">Ditangguhkan</option>
                        <option value="Tidak Disetujui">Tidak Disetujui</option>
                        <?php
