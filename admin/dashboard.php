...
<div class="row top_tiles">
   ...
   <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
     <div class="tile-stats">
       ...
       <h3>Pegawai</h3>
       <p>Jumlah seluruh pegawai di Pengadilan Agama Tanjungpinang Kelas IA</p>
       <hr>
       <div class="text-center small-box">
...
<div class="row top_tiles">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Pegawai <small>Daftar pegawai Pengadilan Agama Tanjungpinang Kelas IA</small></h2>
...
<div class="ccol-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_content text-center">
      ...
      <p>Sistem Informasi Pegawai Pengadilan Agama Tanjungpinang Kelas IA</p>
      <p></p>
      <p>©2025 Pengadilan Agama Tanjungpinang Kelas IA, All Rights Reserved.</p>
    </div>
  </div>
</div>
</div>
